                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-dark">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="POST" action="{{route('coupon.update',$editCoupons['id'])}}">
                                @csrf
                                {{method_field("PUT")}}
                                <div class="card-body col-md-6">
                                    <div class="form-group control-group">
                                        <label for="name">Coupon Code</label>
                                        <input class="form-control" type="text" name="coupon_code" value="{{$editCoupons['coupon_code']}}" required>
                                    </div>
                                    <div class="form-group control-group">
                                        <label for="name">Amount</label>
                                        <input class="form-control" type="text" name="amount" value="{{$editCoupons['amount']}}" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-provide="datepicker">
                                            ...
                                            <input type="date" class="form-control float-right datepicker" name="expiry_date" value="{{$editCoupons['expiry_date']}}">
                                        </div><!-- /.input group -->
                                    </div>
                                </div>
                                <!-- /.card-body -->
