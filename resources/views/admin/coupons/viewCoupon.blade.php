...
<head>
    ...
    <title class="">Farmero &mdash; View Coupons</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-dark">
                            <div class="card-header">
                                <h3 class="card-title">View Coupons</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="prodviewtable" class="table table-bordered table-border table-striped ">
                                    ...
                                    @foreach($coupons as $coup)
                                        ...
                                        ?>
                                        <tr>
                                            <td style="text-align: center">{{ $coup['id'] }}</td>
                                            <td style="text-align: center">{{ $coup['coupon_code'] }}</td>
                                            <td style="text-align: center">{{ $coup['amount'] }}%</td>
                                            <td style="text-align: center">{{ $coup['expiry_date'] }}</td>
                                            <td style="text-align: center;">
                                                <a href="{{ route('coupon.edit',$coup['id']) }}" class="btn btn-primary btn-mini">Edit</a>&nbsp;
                                                <a href="{{ url('/admin/coupon/deleteCoupon/'.$coup['id']) }}" class="btn btn-danger btn-mini" onclick="return confirmDeleteCoupon();">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
