...
<head>
    ...
    <title class="">Farmero &mdash; Dashboard</title>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p style="font-weight:normal;">New Orders</p>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>
              <a href="/admin/viewOrders" class="small-box-footer" style="font-weight:normal;">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <div class="inner">
                ...
                <p style="font-weight:normal;">User Registrations</p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
              <a href="#" class="small-box-footer">&emsp;<i></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
